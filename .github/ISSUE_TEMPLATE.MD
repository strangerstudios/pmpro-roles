...
<!-- Usage questions can also be directed to the support here: https://www.paidmembershipspro.com/support/, unless this is a question about a premium extension in which case you should use the helpdesk. -->
...
- [ ] The issue still exists against the latest `dev` branch of Paid Memberships Pro on Github (this is **not** the same version as the one available on our website paidmembershipspro.com)
